...
EXIT_CONN_TIMEOUT=4		# timeout di connessione
EXIT_SYS_ERROR=5		# errore di sistema/python exception
EXIT_BIND_ERROR=6		# errore nell'ascolto sulla porta (non autorizzato/occupata)
